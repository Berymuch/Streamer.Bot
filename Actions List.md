...
Quotes | 🟥 | 🟥 | This action consolidates all three major quote interactions into one switch tree. Using this logic, users are able to leverage the built in quotes system provided by streamerbot to add, delete, and display random or specific quotes that have been stored. Editing quotes is more easily done vie the built in quote manager and thus a command to do so has not be implemented. | [Berymuch](https://www.twitch.tv/Berymuch) & [ItzApix_](https://www.twitch.tv/ItzApix_)
