...
Summarizer Core | 🟥 | 🟥 | Used to generate an end of stream summary to help you recap. Controls core functions and logic that other associated actions call back to in order to run. | [ItzApix_](https://www.twitch.tv/ItzApix_)
