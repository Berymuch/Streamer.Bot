...
𝘼𝙋𝙄𝙓 Stars | 🟥 | 🟩 | Placeholder | [ItzApix_](https://www.twitch.tv/ItzApix_) & [Berymuch](https://www.twitch.tv/Berymuch)
...
OpenAI Response | 🟥 | 🟩 | Requires a custom OpenAI API key and additional setup as directed within the action. This logic allows you to send queries to OpenAI ChatGPT models and then transmit the responses to Twitch chat. | [ItzApix_](https://www.twitch.tv/ItzApix_) & [Berymuch](https://www.twitch.tv/Berymuch)
