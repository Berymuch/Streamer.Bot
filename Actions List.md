...
Group Shoutout | 🟥 | 🟥 | Allows you to queue up to 10 usernames to be shouted out sequentially via standard Twitch shoutouts, and posts a link in chat for each channel. Shoutouts are sent 2 minutes apart to align with Twitch functions, and intelligently check to ensure users actually exist and that there are no typographical errors in the names. | [Berymuch](https://www.twitch.tv/Berymuch)
