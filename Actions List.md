...
Landmine | 🟩 | 🟩 | Used to plant a chat landmine! Anyone who steps on it with a chat message will trigger it and time themselves out for 15s while also losing 10% of their chat currency. If the deactivation code is guessed correctly (chosen randomly between 2-100), the person who defuses the landmine receives +10% of their total chat currency! Can also plant super landmines which timeout multiple users randomly when triggered. Mods are unable to trigger or be timed out by the mine. Moderators can plant soft or hard landmines- hard ones time users out while soft landmines only surprise! | [Berymuch](https://www.twitch.tv/Berymuch) & [ItzApix_](https://www.twitch.tv/ItzApix_)
