...
Stars system (Award events) | 🟥 | 🟥 | Contains logic that controls how, when, and to what amount stars are aawarded for user interactivity with the stream. | [Berymuch](https://www.twitch.tv/Berymuch)
