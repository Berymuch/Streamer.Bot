...
Landmine | 🟩 | 🟩 | Used to plant a chat landmine! Anyone who steps on it with a chat message will trigger it and time themselves out for 15s. If the deactivation code is guessed correctly (chosen randomly between 2-100), the person who defuses the landmine receives +10% of their total chat currency! Can also plant super landmines which timeout multiple users randomly when triggered.| [Berymuch](https://www.twitch.tv/Berymuch) & [ItzApix_](https://www.twitch.tv/ItzApix_)
