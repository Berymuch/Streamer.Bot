...
!prediction | Creates a prediction on the current stream! !prediction resolve [choice] ends the prediction early with the choice specified as the winner, and (!prediction cancel) terminates the prediction. | [Berymuch](https://www.twitch.tv/Berymuch) & [ItzApix_](https://www.twitch.tv/ItzApix_)
