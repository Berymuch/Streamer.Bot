...
!temp & !t | As above. 
!prediction & !pr | Creates a prediction on the current stream! !prediction resolve [choice] ends the prediction early with the choice specified as the winner, and (!prediction cancel) terminates the prediction.
