...
!watchtime [username or blank] & !watchtime as a chat message reply | Display the date of your watchtime for the current channel on [Twitch](https://www.twitch.tv) in chat. You can specify a specific username after the command to check their information as well. If the command is sent as a reply to another message, it will use the targetted messages author as a target. 
🟦🟦🟦 | 🟦🟦🟦   **USER SPECIFIC**   🟦🟦🟦 | 🟦🟦🟦
