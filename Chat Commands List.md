...
!pin [duration] as reply, and !pin [message] | Pins the replied to message in Twitch chat for the specified number of seconds between 30-1800. If no time is entered, the message is pinned indefinitely. When used as a non-reply command it will pin whatever is input after the command indefinitely (cannot be blank) | [Berymuch](https://www.twitch.tv/Berymuch)
